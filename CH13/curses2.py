...
#-------------------------------------------------------------------------------
# curses2.py
# Demonstrates the use of Python's curses module and a curses sub-window.
# An expansion of the curses1.py example.
#-------------------------------------------------------------------------------
...
def openSubWindow(win):
    # create a sub-window and keep it open until user presses the X
    # key
    ...
    subwin.bkgdset(' ')
    subwin.refresh()
    subwin.addstr(3, 0, "Enter X to exit sub-window")
    subwin.refresh()
    while 1:
        inch = subwin.getch()
        if inch != -1:
